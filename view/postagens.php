...
<div class="container col-md-11 col-lg-10 col-sm-11">
	<div>
		<a href="index.php?ac=novapostagem" class="btn btn-outline-info mt-4 mb-2">Nova Postagem</a>
	</div>
	...
	?>
		...
		<tr>
	      	<td scope="col">
	      		...
	      		<a href="./index.php?postagem&id=<?php echo $lista['idpost']; ?>" style="font-size:18px; color:green">
...
if(($lista['idautor']) == ($_SESSION["iduser"]) || (($_SESSION["nivel"]) == 3 ))
	{ 
?>
...
{ 
?>
    		<a class="dropdown-item" href="./index.php?editar&id=<?php echo $lista['idpost']; ?>"
    		style="color:blue">Editar</a>

<?php
} 
?>
    		<a class="dropdown-item" href="./index.php?excluir&id=<?php echo $lista['idpost']; ?>" 
